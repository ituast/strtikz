...
%Settings for arrows
\tikzset{arrowbe/.style = {arrows={->[length=\arrlen, scale=\dofarrowsizeratio, width=\arrwid, flex=1, bend]}}};
%\tikzset{arrowben/.style = {arrows={<->[length=\arrlen, scale=\dofarrowsizeratio, width=\arrwid, flex=1, bend]}}};

\draw [arrowbe] (0,\offsetdofy) 
...
\draw [arrowbe] (\rotdofstartang:\rotdofradius) ++(\offsetrotx,\offsetroty)
