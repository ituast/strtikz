...
real \driftdist, \driftcurve, \driftcurveratioy, \driftcurveratiox;
real \arrlen, \arrwid;
...
\ifthenelse{\showsuperstructuredof=2}{
	...
	}
	{
		...
		\draw (0,\vertrefstart) -- (0, \y{\doftextfloor}+\storydofshift+\storydofendtick/2);   %Vertical reference line for the DOFs
	}
}{}
