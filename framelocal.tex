...
real \dotradius, \jointinnersepi, \jointinnersepj, \lengthdimoffset, \lengthdimspace, \lengthdimspaceratio;
...
else {\localxstart = \localxstartoffset + \lengthofelement + \lengthdofs + \jdofnodaloffsetx;};
...
{\dofsyz[startx = \startoffsetx, starty = \startoffsety,
length x = \lengthdofs,length y = \lengthdofs,
...
radius = \rotationdofradius, xstring = \inodexdoftext, ystring = \inodeydoftext,
rstring = \inoderdoftext, font size = \doffontsize,
...
%Place only y and z dofs only
\ifthenelse{\placeyzdofsonly=1}
{\dofsyz[startx = \lengthofelement+\endoffsetx, starty = \endoffsety,
length x = \lengthdofs,length y = \lengthdofs,
...
radius = \rotationdofradius, xstring = \jnodexdoftext, ystring = \jnodeydoftext,
rstring = \jnoderdoftext, font size = \doffontsize,
rotation=\dofsrotj, font rotation=\rotationangle+\inodedoftextrot,
font rotation for y = \inodeydoftextrot+\rotationangle,
font rotation for r = \inoderdoftextrot+\rotationangle,
