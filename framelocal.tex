...
\draw [arrowcoord] (\localxstart,0) --
node[at end, inner sep=1pt, outer sep=0, anchor=\rotationangle+180]{\localaxesfontsize \localxtext}(\localxlength+\localxstart,0);
\draw [arrowcoord] (0,\localystart) --
node[at end, inner sep=1pt, outer sep=0, anchor=\rotationangle-90]{\localaxesfontsize \localytext}(0, \localystart+\localylength);
}{}
